...
void vPinmuxInitialize(void)
{
	...
	/* Setting I2C0 functionality for selected pins */
	vPinmuxSel(I2CPins[0].GPIOx, I2CPins[0].pin, I2CPins[0].func); //SDA0
	vPinmuxSel(I2CPins[1].GPIOx, I2CPins[1].pin, I2CPins[1].func); //SCL0

	/* Setting I2C1 functionality for selected pins */
	vPinmuxSel(I2CPins[2].GPIOx, I2CPins[2].pin, I2CPins[2].func); //SDA1
	vPinmuxSel(I2CPins[3].GPIOx, I2CPins[3].pin, I2CPins[3].func); //SCL1

	/* Setting I2C2 functionality for selected pins */
	vPinmuxSel(I2CPins[4].GPIOx, I2CPins[4].pin, I2CPins[4].func); //SDA2
	vPinmuxSel(I2CPins[5].GPIOx, I2CPins[5].pin, I2CPins[5].func); //SCL2
}
